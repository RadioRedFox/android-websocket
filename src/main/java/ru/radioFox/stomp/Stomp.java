...
import ru.radioFox.stomp.provider.OkHttpConnectionProvider;
import ru.radioFox.stomp.provider.WebSocketsConnectionProvider;
...
public class Stomp {
    ...
    private static StompClient createStompClient(ru.radioFox.stomp.provider.ConnectionProvider connectionProvider) {
