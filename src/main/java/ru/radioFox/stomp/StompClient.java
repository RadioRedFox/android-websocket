...
import ru.radioFox.stomp.dto.LifecycleEvent;
import ru.radioFox.stomp.dto.StompCommand;
import ru.radioFox.stomp.dto.StompHeader;
import ru.radioFox.stomp.dto.StompMessage;
import ru.radioFox.stomp.pathmatcher.PathMatcher;
import ru.radioFox.stomp.pathmatcher.SimplePathMatcher;
import ru.radioFox.stomp.provider.ConnectionProvider;


import static ru.radioFox.stomp.dto.LifecycleEvent.Type.*;
...
public class StompClient {
    ...
    public Completable disconnectCompletable() {
        ...
        return connectionProvider.disconnect()
                .doFinally(() -> {
                    ...
                    lifecyclePublishSubject.onNext(new LifecycleEvent(CLOSED));
                });
    }
     ...
     * <p>
     * When set to {@link ru.radioFox.stomp.pathmatcher.RabbitPathMatcher}, topic subscription allows for RMQ-style wildcards.
     * <p>
     *
